...
class Database{
	...
	private $db_pass = "Kasamargit22";  // Change as required
	private $db_name = "oop";	// Change as required
...
/*
		public function idNumber($table){
			if($this->tableExists($table)){
				...
				if($del = @mysql_query($sql)){
					...
					array_push($this->del,mysql_affected_rows());
					$this->myQuery = $del; // Pass back the SQL
					return true; // The query exectued correctly
				}
		}
*/
